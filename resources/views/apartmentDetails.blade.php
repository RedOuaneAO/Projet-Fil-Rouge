            ...
            <div class="row">
                <div class="col-12 col-sm-8">
                    <div class="d-flex mt-5 justify-content-between">
                        <p class=""><span class="fw-bold h5">this apaprtment is hosted by</span> {{$apartDetails[0]->user->name}}</p>
                        <div class=""><img src="/img/{{$apartDetails[0]->user->image}}" width="50" class="rounded-circle" alt=""></div>
                    </div>
                    <div>
                ...
                <div class="card mt-4 shadow-lg border-0" style="height: 70% ;">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="">
                                <button class="btn bg-success text-white fw-bold"  type="button" data-bs-toggle="collapse" data-bs-target="#Filter">Contact The Owner</button>
                                <div class="collapse border-secondary" id="Filter">
                                    <div class="card card-body">
                                        <div class="col-12">
                                            
                                            <p><span class="fw-bold">Phone Number : </span> 06355548</p>
                                        </div>
                                        <div class="col-12">
                                            <p><span class="fw-bold">Email : </span> admin@gmail;com</p>
                                        </div>
